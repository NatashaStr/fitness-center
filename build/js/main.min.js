...
/* harmony import */ var _modules_swiper_trainers__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/swiper-trainers */ "./js/modules/swiper-trainers.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_modals_tabs__WEBPACK_IMPORTED_MODULE_3__["activateTabs"])();
  Object(_modules_swiper_trainers__WEBPACK_IMPORTED_MODULE_4__["initSwiperTrainers"])(swiper);
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_modals_video__WEBPACK_IMPORTED_MODULE_2__["videoEnabled"])();
  });
});
...
var activateTabs = function activateTabs() {
  var tabs = document.querySelectorAll('.subscription__tabs-item');
  var tabsContent = document.querySelectorAll('.subscription__cards-wrapper');
  if (tabs) {
    tabs.forEach(function (tab) {
      tab.addEventListener('click', function (evt) {
        ...
        if (evt.target.classList.contains('subscription__tabs-item--active') && evt.target.dataset.button === '#tab-6') {
          var _content = document.querySelector('#tab-6');
          _content.classList.add('subscription__cards-wrapper--active');
        }
        if (evt.target.classList.contains('subscription__tabs-item--active') && evt.target.dataset.button === '#tab-12') {
          var _content2 = document.querySelector('#tab-12');
          _content2.classList.add('subscription__cards-wrapper--active');
        }
      });
    });
  }
...
var videoEnabled = function videoEnabled() {
  var video = document.querySelector('.intro__video-wrapper');
  ...
  if (video) {
    var link = document.querySelector('.intro__video-link');
    var button = document.querySelector('.intro__button');
    var borderButton = document.querySelector('.intro__border-button');
...
/***/ "./js/modules/swiper-trainers.js":
/*!***************************************!*\
  !*** ./js/modules/swiper-trainers.js ***!
  \***************************************/
/*! exports provided: initSwiperTrainers */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initSwiperTrainers", function() { return initSwiperTrainers; });
var initSwiperTrainers = function initSwiperTrainers(swiper) {
  if (swiper) {
